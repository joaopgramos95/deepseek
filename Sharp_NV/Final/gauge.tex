...
For~\eqref{wbd1}, group every boundary contribution in~\eqref{w1} whose uncoloured underlying tree is $\TT$ (compare with~\eqref{Bcherry2}); the cumulative multiplier reads
\[
