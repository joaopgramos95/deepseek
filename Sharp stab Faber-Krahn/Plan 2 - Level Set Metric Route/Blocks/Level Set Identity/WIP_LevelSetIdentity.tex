...
\cite[Thm.~0.4 and \S1]{BBC1975}.  The exceptional set where
$m'=0$ has zero image measure because $m$ is absolutely continuous.
Since $m'=-\alpha$, this gives~\eqref{eq:L3c}.  Finally
