...
eigenvalue.  Apart from the Fusco--Julin sharp quantitative isoperimetric
inequality (Theorem~\ref{thm:FJ-strong}) and standard tools for sets of finite
perimeter, the argument -- including the bounded reduction and the Kohler--Jobin
inequality -- is self-contained.
\end{abstract}
...
draft gives a structurally different proof, self-contained modulo the Fusco--Julin
sharp quantitative isoperimetric inequality (Theorem~\ref{thm:FJ-strong}) and
...
consequences.  Section~\ref{sec:samecentre} invokes the Fusco--Julin strong form and converts
it into same-centre control of the homothetic trace.
...
The one deep external input is the Fusco--Julin strong-form inequality
(Theorem~\ref{thm:FJ-strong}); all other ingredients are either proved here or
are classical tools for sets of finite perimeter, collected in
...
Fusco--Julin strong form (Theorem~\ref{thm:FJ-strong});
...
\label{rem:FJ-status}
Theorem~\ref{thm:FJ-strong} is the only deep external ingredient of the proof.
At the sharp scaling it supplies a \emph{single} centre controlling
simultaneously the volume asymmetry and the boundary-normal oscillation of
\(E\); this same-centre feature is exactly what the oriented radial trace below
converts into homothetic-trace control.  The weaker volume-only bound
\eqref{eq:constructive-volume} is the constructive Fraenkel inequality of
Theorem~\ref{thm:constructive-fraenkel}, which is used (independently of the
strong form) in the bounded reduction and in the endpoint trace.
\end{remark}
...
on the Fusco--Julin strong form (Theorem~\ref{thm:FJ-strong}); the passage from
same-centre volume and normal control to the homothetic trace is the radial trace
...
Every step is either proved in this manuscript, invokes the Fusco--Julin strong
form (Theorem~\ref{thm:FJ-strong}), or is quoted from a named published theorem.
...
oriented radial trace, the same-centre package (via the Fusco--Julin strong
form), the velocity defect, and the
...
\emph{Quoted with exact citation:} the Fusco--Julin sharp quantitative
isoperimetric inequality \cite{FJ2014}; the constructive Fraenkel quantitative
