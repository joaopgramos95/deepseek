...
$\partial_r\widetilde u_g\ge1/(2N)$ for $\delta_0$ small, the map
$t\mapsto\sqrt t$ is Lipschitz on a neighborhood of $1/N^2$, yielding
\[
...
\]
is now end-to-end and rigorous. The BDV nearly spherical second variation is
not used.
