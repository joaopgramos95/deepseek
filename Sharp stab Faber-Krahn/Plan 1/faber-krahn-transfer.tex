...
The full chain for sharp Faber--Krahn stability is now end-to-end:
\begin{enumerate}
\item Sharp Saint--Venant stability at fixed volume:
\texttt{fixed-domain-bernoulli-expansion.md}, Theorem~6.3.
\item Kohler--Jobin transfer:
Lemma~\ref{lem:pointwise} + Lemma~\ref{lem:linear} + small/large split:
Theorem~\ref{thm:fk}.
\end{enumerate}
