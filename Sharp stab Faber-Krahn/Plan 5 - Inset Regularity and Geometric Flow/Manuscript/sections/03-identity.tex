...
and for such $v$ the level set $\{u=v\}$ is a smooth one-dimensional
submanifold of $\Om$ and the coarea quotient $1/|\nabla u|$ is finite and
...
\[
   ...
   =|\Om|=\pi<\infty ,
\]
where the middle equality uses \cref{lem:crit-zero}. Hence $\Phi\in
