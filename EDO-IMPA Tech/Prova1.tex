...
\begin{enumerate}[label=(\alph*)]
    \item $y' - 3y = 6e^{3t}, \qquad y(0) = 1.$
    \item $y' = \dfrac{t}{y}, \qquad y(0) = 2.$
    \item $y' = \dfrac{2t + y}{t}, \qquad y(1) = 1, \qquad t > 0.$ \\
...
\]
\begin{enumerate}[label=(\alph*)]
    \item Encontre todas as soluções de equilíbrio e classifique cada uma como estável ou instável.
    \item Suponha que $x(0) = x_0$ com $x_0 \in (0, \pi)$. Prove que a solução $x(t)$ está definida para todo $t \geq 0$.
\end{enumerate}
...
\begin{enumerate}[label=(\alph*)]
    \item Qual é a menor ordem $n$ que essa equação pode ter?
    \item Escreva uma equação diferencial de ordem mínima que tenha ambas as funções como soluções.
\end{enumerate}

\vspace{5mm}

\noindent {\bf Problema 4.} Prove que toda solução $y$ da equação diferencial
    \[
    y'' + y^3 = 0
    \]
    é limitada. 
...
\noindent {\bf Problema 5.} Encontre todas as funções $f: \R \to (0,+\infty)$ tais que 
\[
f'' \cdot f \geq 2(f')^2.
\]
